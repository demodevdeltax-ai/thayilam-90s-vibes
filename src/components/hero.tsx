...
export function Hero() {
  ...
  function handleVideoEnd() {
    ...
    setTimeout(() => {
      setShowLogo(false);
      // Small delay so video starts just as logo fades out
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8 pt-12 pb-16 md:pt-20 md:pb-24 grid md:grid-cols-12 gap-10 items-center">
        ...
        <div className="md:col-span-5 relative flex items-center justify-center">
          <div className="relative w-full aspect-square max-w-[460px]">
            ...
            {/* Video — no loop, manually restarted after logo */}
            <video
              ref={videoRef}
            ...
            <span className="absolute top-4 -right-2 paper-sand ink-border-thin rounded-full h-20 w-20 grid place-items-center text-center text-[10px] uppercase tracking-widest text-brown/80 stamp-rotate-r leading-tight z-10">
