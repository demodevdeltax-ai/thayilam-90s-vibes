    ...
    <section className="paper py-10 md:py-14 border-b border-brown/20">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="flex items-end justify-between mb-6">
          ...
          <a href="#shop" className="hidden sm:inline text-xs uppercase tracking-widest text-rust hover:underline">
            View all →
          </a>
        </div>
        ...
        <div className="-mx-5 md:-mx-8 px-5 md:px-8 overflow-x-auto scrollbar-none">
          <ul className="flex gap-5 md:gap-7 min-w-max pb-2">
            {CATEGORIES.map(({ label, Icon }) => (
              <li key={label}>
                <button className="group flex flex-col items-center gap-3 w-20 md:w-24 focus:outline-none">
